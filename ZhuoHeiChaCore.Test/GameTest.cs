...
namespace ZhuoHeiChaCore.Test
{
    public class GameForTestTest : Game
    {
        ...
        public void ReturnTribute_WhenPlayerDoesntHaveCards_ShouldThrowException()
        {
            ...
            _cardsInHandByPlayerId[1] = new List<Card> { _cardFactory.GetCardByCardType(CardType.SPADE_FOUR) };
        ...
        public void ReturnTribute_WhenPlayerIdsAndCardsAreValid_ShouldReturnUpdatedPlayerCards()
        {
            ...
            _tributePairs.Clear();
            _tributePairs.AddRange(new List<(int, int)> { (1, 0), (2, 0) });
            ...
            ReturnTribute(1, 0, cardList);

            cardList = new List<Card> { _cardFactory.GetCardByCardType(CardType.HEART_FOUR) };
            Console.WriteLine(ReturnTribute(2, 0, cardList));


        }

        // 1->0,2->0; now 0 return 1, 0 return 2
        [Fact]
        public void ReturnTribute_PublicAceWin_ShouldReturnTwoCardsToEachPlayer()
        {
            _cardsInHandByPlayerId.Clear();
            _cardsInHandByPlayerId[0] = new List<Card> { _cardFactory.GetCardByCardType(CardType.SPADE_FOUR), _cardFactory.GetCardByCardType(CardType.HEART_FOUR), _cardFactory.GetCardByCardType(CardType.CLUBS_FOUR), _cardFactory.GetCardByCardType(CardType.DIAMOND_FOUR) };
            _cardsInHandByPlayerId[1] = new List<Card> { };
            _cardsInHandByPlayerId[2] = new List<Card> { };
            ...
            _tributePairs.AddRange(new List<(int, int)> { (1, 0), (2, 0) });
            _playerTypeList.Clear();
            _playerTypeList.AddRange(new List<PlayerType> { PlayerType.PublicAce, PlayerType.Normal, PlayerType.Normal });

            var cardList = new List<Card> { _cardFactory.GetCardByCardType(CardType.SPADE_FOUR), _cardFactory.GetCardByCardType(CardType.CLUBS_FOUR) };
            ReturnTribute(1, 0, cardList);

            cardList = new List<Card> { _cardFactory.GetCardByCardType(CardType.HEART_FOUR), _cardFactory.GetCardByCardType(CardType.DIAMOND_FOUR) };
            Console.WriteLine(ReturnTribute(2, 0, cardList));
